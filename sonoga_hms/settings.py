...
SONOGA_WORDPRESS_REQUIRE_SIGNATURE = env_bool("SONOGA_WORDPRESS_REQUIRE_SIGNATURE", False)
SONOGA_WORDPRESS_SIGNATURE_TOLERANCE = int(os.getenv("SONOGA_WORDPRESS_SIGNATURE_TOLERANCE", "300"))
SONOGA_WORDPRESS_ALLOWED_IPS = set(env_list("SONOGA_WORDPRESS_ALLOWED_IPS", ""))
SONOGA_WORDPRESS_TRUST_PROXY_IP_HEADERS = env_bool("SONOGA_WORDPRESS_TRUST_PROXY_IP_HEADERS", False)
